...
import com.weixiao.bookstore.core.CustomRequest;
...
//        CustomRequest jsObjRequest = new CustomRequest(Request.Method.GET, Constants.DATA_URL, null, new Response.Listener<JSONObject>() {
//            @Override
...
//        requestQueue.add(jsObjRequest);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Constants.DATA_URL, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
